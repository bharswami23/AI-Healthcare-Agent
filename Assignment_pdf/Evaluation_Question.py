...
#API_KEY="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"
#API_KEY="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"
#API_KEY="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"
API_KEY="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"
trans_model = "bge_large";
with open("sentence_transformer_model.txt","r") as f:
    trans_model = f.read().strip();
...
def query_decomp_tool(query: str, model=llmmodel):
    ...
    - MAXIMUM 5 subquestions, MINIMUM 3. This requirement is to be strictly followed.
    ...
    - If the query involves reasoning, explanation, or causal inference:
        ...
        - Include at least one integrative subquestion connecting multiple concepts
...
def query_answer_tool(query,subqs,context,model=llmmodel):
    ...
    Answer all parts of the question and subquestions COMPLETELY using ONLY the information provided in the context.
    ...
    - A citation MUST be provided for every claim made
