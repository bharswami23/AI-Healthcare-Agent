...
def query_answer_tool(query,subqs,context,model=""):
    ...
    RULES:
    - If the answer cannot be obtianed from the context, just return a [] and NO OTHER TEXT. DO NOT force yourself to associate a context with the question.
    ...
    MANDATORY:
    - If the answer cannot be obtianed from the context, just return a []. DO NOT force yourself to associate a context with the question.
