...
def query_decomp_tool(query: str, model=""):
    ...
    - Don't hallucinate. 
    - If no subquestions are possible, or if the question is meaningless, just return [].
...
def query_answer_tool(query,subqs,context,model=""):
    ...
    RULES:
    - If the answer cannot be obtianed from the context, just return a [] and NO OTHER TEXT. DO NOT associate a context to the question for the sake of it.
